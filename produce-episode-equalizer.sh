...
ffmpeg -y -i .artifacts/alex-stitched.flac -af highpass=110,lowpass=7500 .artifacts/alex-passesHL.flac &
ffmpeg -y -i .artifacts/seb-stitched.flac -af highpass=125,lowpass=6500 .artifacts/seb-passesHL.flac &
wait

LOG "(2.5/7) EQUALIZER"
ffmpeg -y -i .artifacts/alex-passesHL.flac -af "equalizer=f=600:width_type=h:width=500:g=-6" .artifacts/alex-passes.flac &
ffmpeg -y -i .artifacts/seb-passesHL.flac -af "equalizer=f=600:width_type=h:width=500:g=-6" .artifacts/seb-passes.flac &
wait
...
ffmpeg -y -i .artifacts/alex-passes.flac -filter_complex "compand=points=-40/-900|-35/-25|-30/-18|-25/-16|-20/-13|-15/-10|-10/-5|0/0|20/0" -ar 44100 .artifacts/alex-compressed.flac &
ffmpeg -y -i .artifacts/seb-passes.flac -filter_complex  "compand=points=-40/-900|-35/-25|-30/-18|-25/-16|-20/-13|-15/-10|-10/-5|0/0|20/0" -ar 44100 .artifacts/seb-compressed.flac &
wait
